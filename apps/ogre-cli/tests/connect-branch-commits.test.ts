...
import connectBranchCommits from '../source/graph/compute-graph-map/connect-branch-commits.js';
import {GraphSymbol} from '../source/graph/compute-graph-map/index.js';
...
test('should not modify an empty line', () => {
	const emptyLine = [];
